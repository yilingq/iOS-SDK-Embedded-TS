...
if (RBA_SDK_Reconnect() == RESULT_SUCCESS) {
    ...
    //! \cond INSTANCE_FUNCS
    typedef void (*RbaConnectedCallBackWithInstanceId)(unsigned int);
    //! \endcond
    ...
    //! \cond INSTANCE_FUNCS
    DLLEXPORT int RBA_SDK_SetNotifyRbaConnectedFor(unsigned int instanceId, RbaConnectedCallBackWithInstanceId cbRbaIsReadyListener);
    //! \endcond
    ...
    //! \cond INSTANCE_FUNCS
    typedef void (*RbaDisconnectedCallBackWithInstanceId)(unsigned int);
    //! \endcond
    ...
    //! \cond INSTANCE_FUNCS 
	DLLEXPORT int RBA_SDK_SetNotifyRbaConnectedFor(unsigned int instanceId, RbaDisconnectedCallBackWithInstanceId cbRbaDisconnectedListener);
    //! \endcond
...
String interval = RBA_SDK_API.GetAttribute(
    ...
    //! \cond INSTANCE_FUNCS
    DLLEXPORT int   RBA_SDK_GetAttributeLenFor(unsigned int instanceId, int id, char * data, int *len );
    //! \endcond
...
if( [RBA_SDK GetTagParamLen:M33_05_EMV_AUTHORIZATION_CONFIRMATION] <= 0 )
{
    ...
    //! \cond INSTANCE_FUNCS
    DLLEXPORT int   RBA_SDK_GetTagParamLenFor(unsigned int instanceId);
    //! \endcond
